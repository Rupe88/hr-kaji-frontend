// API Configuration
export const API_URL = process.env.NEXT_PUBLIC_API_URL || 'https://sea-turtle-app-vd9z6.ondigitalocean.app';
...
export const API_ENDPOINTS = {
  ...
  KYC: {
    INDIVIDUAL: {
      ...
      DELETE: (userId: string) => `/api/individual-kyc/${userId}`,
    ...
    INDUSTRIAL: {
      ...
      DELETE: (userId: string) => `/api/industrial-kyc/${userId}`,
