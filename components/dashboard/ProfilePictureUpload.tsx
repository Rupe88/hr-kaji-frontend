  ...
  const handleUpload = async (file: File) => {
    ...
    try {
      ...
      const response = await api.post<{ success: boolean; data: User; message?: string }>(
        API_ENDPOINTS.AUTH.UPDATE_PROFILE_PICTURE,
        formData,
        {
          headers: {
    ...
    <div className="relative inline-block">
      <div className="relative">
        {displayImage ? (
          ...
          <div className="w-24 h-24 rounded-full bg-gradient-to-br from-teal-400 to-purple-600 flex items-center justify-center text-white font-bold text-2xl border-4" style={{ borderColor: 'oklch(0.7 0.15 180 / 0.5)' }}>
