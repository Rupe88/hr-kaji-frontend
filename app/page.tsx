    ...
    <div className="relative min-h-screen bg-black overflow-hidden">
      ...
      <section className="relative z-10 py-16 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6" style={{ fontFamily: 'var(--font-poppins)' }}>
      ...
      <section className="relative z-10 py-16 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-gray-400 max-w-2xl mx-auto">
              Chosen by thousands of companies and job seekers worldwide
            </p>
          </motion.div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              >
                {[
                  ...
                  >
                    <div className="text-2xl sm:text-3xl lg:text-4xl font-extrabold mb-1 sm:mb-2" style={{ color: stat.color, fontFamily: 'var(--font-poppins)' }}>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-400 mb-8 sm:mb-12 max-w-2xl mx-auto px-4">
              Join thousands of companies using BTBAJ to find the best talent and grow their teams.
            </p>
