                                    ...
                                    <div className="mt-1 text-xs text-gray-300 space-y-0.5">
                                      ...
                                      {app.applicant.address && (
                                        <p className="flex items-center gap-1.5">
                                          ...
                                          {app.applicant.address.city}, {app.applicant.address.district}
                                        </p>
                                      )}
                                    </div>
                                  </div>
                                  ...
                                  <div className="mt-1 text-xs text-gray-300 space-y-0.5">
                                    {app.applicant.phone && (
                                      <p className="flex items-center gap-1.5">
                                        ...
                                        {app.applicant.phone}
                                        <a href={`tel:${app.applicant.phone}`} className="ml-2 text-teal-400 hover:underline">Call Now</a>
                                      </p>
                                    )}
                                    {app.applicant.address && (
                                      <p className="flex items-center gap-1.5">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-white flex items-center gap-2">
                        ...
                        <a href={`tel:${job.contactPhone}`} className="hover:text-teal-400 hover:underline transition-colors">{job.contactPhone}</a>
                      </p>
                      {job.contactMethod && (
